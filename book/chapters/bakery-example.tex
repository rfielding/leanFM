...
For the bakery, the selected implementation backend is Go. The generated code
uses Go protobuf bindings, deterministic \texttt{proto.Marshal},
\texttt{proto.Unmarshal}, and bounded channels. Requirement comments are emitted
beside the symbols and statements they justify:

\lstinputlisting[language=Go,basicstyle=\ttfamily\scriptsize]{examples/bakery-generated.go}
